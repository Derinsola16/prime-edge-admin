...
const tabs = ["All Transactions", "Property Payment", "Return on Investments", "Withdrawals"]
...
export default function DashboardPage() {
  ...
  const { data: tasksRes } = useQuery({ queryKey: ["pending-tasks"], queryFn: getPendingTasks })
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      {metricsRes && <DashboardMetrics metrics={metricsRes.data} />}

      {tasksRes && <PendingTasks tasks={tasksRes.data.items} />}
